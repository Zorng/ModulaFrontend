...
class _BranchDetailPageState extends ConsumerState<BranchDetailPage> {
  ...
  bool get _canSave {
    ...
    if (_nameError != null || _addressError != null || _phoneError != null || _emailError != null) return false;
    return true;
  }

  void _toggleEditMode() {
    if (_isEditMode) {
      final branch = ref.read(branchStoreProvider).value
          ?.firstWhere((b) => b.id == widget.branchId);
      if (branch != null) {
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _DropdownField(
                          label: 'Status',
                          value: _selectedStatus ?? branch.status,
                          enabled: false,
...
const _fieldBorderRadius = BorderRadius.all(Radius.circular(8));
final _fieldBorder = Border.all(color: Colors.grey.shade300, width: 2);

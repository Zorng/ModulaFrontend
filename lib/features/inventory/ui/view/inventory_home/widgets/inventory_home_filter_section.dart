...
class InventoryHomeFilterSection extends StatelessWidget {
  const InventoryHomeFilterSection({
    super.key,
  ...
  final List<InventoryHomeFilterStatusItem> filterStatusItems;
  final bool hasFiltersApplied;
  final VoidCallback onFilterPressed;

  @override
  Widget build(BuildContext context) {
    return _InventoryHomeFilterHeader(
...
class _InventoryHomeFilterHeader extends StatelessWidget {
  const _InventoryHomeFilterHeader({
    required this.filterStatusItems,
    required this.hasFiltersApplied,
    required this.onFilterPressed,
  });
...
class _FilterInfoCard extends StatelessWidget {
  ...
  final InventoryHomeFilterStatusItem item;
